        ...
        public IEnumerator PlaceAssetsAsync()
        {
            ...
            if (scene == "MountainPassRegion" && Settings.options.sunderedPlank)
            {
                ...
                yield return PlaceAssetAsync("OBJ_WoodPlankSingle",
                    new Vector3(380.9419f, 462.3344f, -607.3192f),
                    new Vector3(1.4751f, 32.2775f, 6.54f),
                    new Vector3(3.85f, 2f, 3.5f));
            }
            else if (scene == "LongRailTransitionZone" && Settings.options.branchlineSkip)
            {
                // Tracks Exit Black
                yield return PlaceAssetAsync("OBJ_WoodPlankSingle2",
                    new Vector3(92.0998f, 0.6497f, -580.5698f),
                    new Vector3(87.8053f, 22.8065f, 359.6488f),
                    new Vector3(50f, 5f, 30f));

                // Hub Exit Black
                yield return PlaceAssetAsync("OBJ_WoodPlankSingle2",
                    new Vector3(-176.7968f, -1.0809f, 1234.891f),
                    new Vector3(82.5236f, 5f, 0.0001f),
                    new Vector3(50f, 5f, 30f));
            }
        }
